...
def create_app(test_config=None):
    ...
    def get_questions():
        ...
        category_data = [category.format() for category in Category.query.all()]
        categories = []
        for data in category_data:
            categories.append(data['type'])
        current_category = categories[len(categories)//2]
    ...
    '''
     #-------------------------------------------
     # Implemented in create_or_search_question()
     #          
    ...
    def create_or_search_question():
        ...
        try:
            if search:
                ...
                question = Question(id=new_id, category=new_category, difficulty=new_difficulty, question=new_question, answer=new_answer)
    ...
    def get_by_category(category_id):
        ...
        try:
            questions_per_page = paginate_questions(request, selection)
